...
Iris::Module::Module (std::string _name, std::string _label, std::string _img_path,
...
void
Iris::Module::debug_css ()
{
  std::cout << "Module: " << this->get_name () << " Class: " << this->get_css_classes ()[0]
